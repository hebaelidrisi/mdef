...
=== "Cognitive Orgies II"
   ...
   ***What if you could whisper your secrets to a tree that promises to store it forever in the depths of it's heart in a language no one else understands? What if you could go back to hear it whisper it back to you again?***
    ...
    Building off of the ongoing desire to restore a more meaningful relationship with Earth, “Seeding Memories” is a secret memory encrypting system that merges real-time human audio with the living pulses of a tree, forming a private memory archive in the tree. 
